...
import { FaCompass, FaGlobeAsia, FaHeart } from 'react-icons/fa';
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              >
                <div className="mb-4 flex justify-center text-[#3E2C23]">
                ...
                {item.text ? (
                  <p className="text-gray-600 font-sans">{item.text}</p>
                ) : (
                  <ul className="list-none text-gray-600 font-sans space-y-2">
