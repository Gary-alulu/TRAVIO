...
const includedFeatures = [
  { icon: FaPlane, title: "Flights", description: "Return flights included" },
  { icon: FaHotel, title: "Accommodation", description: "Luxury resort stay" },
  { icon: FaUtensils, title: "Meals", description: "Full board meals" },
  { icon: FaBusAlt, title: "Transportation", description: "Private transfers" },
  { icon: FaHiking, title: "Activities", description: "Guided tours" },
];
            ...
            <section className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {includedFeatures.map((feature, idx) => (
                  ...
                  >
                    <feature.icon aria-hidden="true" className="text-4xl mb-4 block text-[#3E2C23]" />
                      ...
                      <div>
                        ...
                        <div className="flex gap-1">
                          {Array.from({ length: review.rating }).map((_, i) => (
                            <FaStar key={i} aria-hidden="true" className="text-yellow-400" />
                          ))}
                        </div>
                      </div>
                    </div>
            ...
            <div className="sticky top-24 bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <FaStar aria-hidden="true" className="text-yellow-400" />
