  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl font-serif font-bold text-[#3E2C23] mb-8 text-center font-playfair-display">
        ...
        <Accordion variant="splitted" selectionMode="multiple">
          {faqs.map((faq) => (
            ...
            >
              <p className="text-gray-600 font-sans text-sm pb-2">{faq.content}</p>
            </AccordionItem>
          ))}
        </Accordion>
      </div>
