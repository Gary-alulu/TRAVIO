  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-sans">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="font-playfair-display text-5xl md:text-7xl font-bold mb-6">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-0 left-0 p-6 w-full">
                  ...
                  <h3 className="text-xl font-playfair-display mt-2">{image.location}</h3>
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 text-white">
              <h3 className="text-2xl font-playfair-display">{selectedImage.location}</h3>
      ...
      <section className="bg-[#3E2C23] py-20">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-playfair-display text-4xl md:text-5xl font-bold mb-6">
