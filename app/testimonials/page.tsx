  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0] text-[#3E2C23] font-sans">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        >
          <h1 className="font-playfair-display text-4xl md:text-6xl font-bold mb-6">
                      ...
                      <div>
                        <div className="flex items-center mb-2">
                          {[...Array(testimonial.rating)].map((_, i) => (
                            <FaStar key={i} aria-hidden="true" className="text-yellow-400 text-xl" />
                          ))}
                        </div>
      ...
      <section className="bg-[#3E2C23] text-white py-16">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-playfair-display text-3xl md:text-4xl font-bold mb-6">
