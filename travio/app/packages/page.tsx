...
const categories = [
  { 
    ...
    icon: '🏖️', 
    bg: '/destinations/explore by category/BEACHES.jpg' 
  },
  { 
    key: 'mountains', 
    label: 'Mountains', 
    ...
    icon: '⛰️', 
    bg: '/destinations/explore by category/MOUNTAINS.jpg' 
  },
  { key: 'cities', label: 'Cities', desc: 'Urban explorations and nightlife', icon: '🏙️', bg: '/destinations/explore by category/CITIES.jpg' },
  { key: 'culture', label: 'Cultural Escapes', desc: 'Historical and local immersion', icon: '🏛️', bg: '/destinations/explore by category/CULTURAL ESCAPE.jpg' },
];
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-100">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-yellow-600 text-sm font-semibold">★ {trip.rating}</span>
                    </div>
                    <button
