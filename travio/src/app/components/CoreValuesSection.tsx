...
export default function CoreValuesSection() {
  return (
    <section className="bg-[#FFF8F0] py-20 px-8 md:px-16">
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
        {/* Left Column */}
        <div className="flex-1 w-full max-w-xl">
          <motion.h2
            className="text-3xl md:text-5xl font-bold text-[#3E2C23] mb-6 font-sans"
          ...
          <motion.p
            className="text-lg text-[#5A4633] mb-8 font-light"
